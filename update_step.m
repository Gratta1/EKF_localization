...
H = [(X(1) - X(2+2*i))/range(i), (X(2) - X(2+2*i+1))/range(i), 0, (X(2+2*i) - X(1))/range(i), (X(5) - X(2+2*i+1))/range(i); ...
    (X(2+2*i+1) - X(2))/range(i)^2, (X(1) - X(2+2*i))/range(i)^2, -1, (X(2+2*i+1) - X(5))/range(i)^2, (X(2+2*i) - X(1))/range(i)^2 ];
